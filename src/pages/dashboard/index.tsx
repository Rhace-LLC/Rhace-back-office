...
const mockOrders = [
  { id: 'ORD-001', table: 'Table 5', status: 'Preparing', time: '15:30', total: 45.50 },
  { id: 'ORD-002', table: 'Table 2', status: 'Pending', time: '15:25', total: 32.75 },
  { id: 'ORD-003', table: 'Table 8', status: 'Served', time: '15:20', total: 67.25 },
  { id: 'ORD-004', table: 'Table 1', status: 'Preparing', time: '15:15', total: 28.50 },
];
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">2 occupied, 2 free</p>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {mockTables.filter(t => t.waiter === user?.name).map((table) => (
                  <div key={table.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <Badge variant={table.status === 'Occupied' ? 'destructive' : table.status === 'Free' ? 'default' : 'secondary'}>
                        {table.status}
                      </Badge>
                    </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {mockOrders.filter(o => o.status !== 'Served').slice(0, 3).map((order) => (
                  <div key={order.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      <div className="text-sm">{order.id}</div>
                      <div className="text-xs text-muted-foreground">{order.table} • {order.time}</div>
                    </div>
    ...
    return (
      <div className="p-5 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage incoming orders and preparation queue</p>
        </div>
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" className="bg-[#2542e3]">Complete</Button>
                      </div>
                    </TableCell>
                  </TableRow>
                ))}
  ...
  return (
    <div className="p-5 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Restaurant overview and key performance indicators</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">12/16 tables</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={revenueData}>
                ...
                <XAxis dataKey="name" />
                <YAxis />
                <Tooltip formatter={(value: any) => [`$${value.toString()}`, 'Revenue']} />
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell><Badge className="bg-green-100 text-green-800">Excellent</Badge></TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell><Badge className="bg-yellow-100 text-yellow-800">Good</Badge></TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
